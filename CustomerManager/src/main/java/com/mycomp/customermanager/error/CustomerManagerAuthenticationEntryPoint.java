...
@Component
public class CustomerManagerAuthenticationEntryPoint implements AuthenticationEntryPoint {
	...
	public CustomerManagerAuthenticationEntryPoint(ObjectMapper mapper) {
