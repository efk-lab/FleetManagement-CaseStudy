...
public class ServerSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public ServerSecurityConfiguration(CustomerManagerAuthenticationEntryPoint customAuthenticationEntryPoint, @Qualifier("userService") UserDetailsService userDetailsService) {
