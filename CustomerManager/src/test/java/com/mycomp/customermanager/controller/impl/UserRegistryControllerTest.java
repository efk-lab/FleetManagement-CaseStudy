...
import com.mycomp.customermanager.CustomerManagerApplicationTest;
...
@ContextConfiguration(classes = CustomerManagerApplicationTest.class)
...
public class UserRegistryControllerTest {
	...
	public void testSignUp() throws Exception {
		...
		this.mockMvc.perform(post("/customermanager/registry/sign-up")
