...
@RequestMapping("/fleetmanager/registry")
public interface UserRegistryController {
	...
	public ResponseEntity<SignUpResponse> signUp(@Valid @RequestBody SignUpRequest signUpRequest) throws FleetManagerException;
