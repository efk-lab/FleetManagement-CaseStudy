package com.mycomp.fleetmanager.conf.swagger;
...
public class SwaggerConfiguration {
	...
	private final String API_TITLE = "FleetManager";
	private final String API_DESCRIPTION = "FleetManager Document";
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.mycomp.fleetmanager"))
