package com.mycomp.vehiclemanager.conf.swagger;
...
public class SwaggerConfiguration {
	...
	private final String API_TITLE = "VehicleManager";
	private final String API_DESCRIPTION = "VehicleManager Document";
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.mycomp.vehiclemanager"))
